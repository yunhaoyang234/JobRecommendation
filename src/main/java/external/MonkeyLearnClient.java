...
public class MonkeyLearnClient {
	private static final String API_KEY = "7c5e3d1faa7aebd14a350c8ec8e6ea2c7b39492a";
	private static final String MODEL_ID = "ex_YCya9nrn";

	public static void main( String[] args ) throws MonkeyLearnException {
        String[] data = {"Elon Musk has shared a photo of the spacesuit designed by SpaceX. ",
        		"This is the second image shared of the new design and the first to feature",
        		" the spacesuit’s full-body look."};
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		ExtraParam[] extraParams = { new ExtraParam("max_keywords", "10") };
